...
- [The Hugo Zen theme](#the-hugo-zen-theme)
  - [Demo site](#demo-site)
  ...
  - [Updating](#updating)
    - [Hugo module](#hugo-module-1)
    - [Git submodule](#git-submodule-1)
  ...
  - [Customise](#customise)
    ...
    - [Colours and variables](#colours-and-variables)
    - [Logo](#logo)
    - [Favicons](#favicons)
    - [Head and footer partials](#head-and-footer-partials)
    - [Layouts](#layouts)
      - [Menu and sidebar layouts](#menu-and-sidebar-layouts)
    - [CSS grid for layout](#css-grid-for-layout)
    - [Other styles and scripts](#other-styles-and-scripts)
  - [Render hook templates](#render-hook-templates)
    - [Add anchor links to headings](#add-anchor-links-to-headings)
    - [Process Markdown images](#process-markdown-images)
    - [Make external links open in a new tab.](#make-external-links-open-in-a-new-tab)
  - [Multilingual](#multilingual)
    - [Non English site](#non-english-site)
  - [Search](#search)
